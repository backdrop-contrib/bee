...
class MultisiteInstallCommandsTest extends TestCase {
  ...
  public function test_install_command_works() {
    ...
    // Install the site.
    $output_install = shell_exec("bee install --site=install_test --db-name=install_test --db-user=backdrop --db-pass=backdrop --db-host=$bee_test_db_host --auto");
    ...
    exec("mysql -h $bee_test_db_host -u root -e 'DROP DATABASE install_test; CREATE DATABASE install_test; GRANT ALL PRIVILEGES ON install_test.* TO \"backdrop\"@\"%\" IDENTIFIED by \"backdrop\";'");
  }
